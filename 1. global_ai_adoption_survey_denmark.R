...
# Tested with R 4.5.2. Original author: Reem Saad - version 3. Paths made
...
# Github: https://github.com/mauriziosessaku/global-ai-adoption-survey-denmark
...
#### OPTIONAL!! and remember if its table modified or not #####
...
p_government_panel_updated <- p_government_compare +
  labs(
    title = "Level of government",
    subtitle = NULL,
    x = NULL,
...
p_sex_panel_updated <- p_sex_compare +
  labs(
    title = "Sex",
    subtitle = NULL,
    x = NULL,
...
p_domain_panel_updated <- p_domain_compare +
  labs(
...
### Individual figures with sample size ###
